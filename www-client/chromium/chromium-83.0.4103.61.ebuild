...
# tcmalloc useflag and musl: as far as I know, musl doesn't supports malloc
# interposition, so tcmalloc cannot compile with musl.
# component-build useflag and musl: could not compile with it.
...
PATCHES=(
	...
	"${FILESDIR}/${PN}-83.0.4103.61-musl-fixes.patch"
	"${FILESDIR}/${PN}-83.0.4103.61-musl-fixes-breakpad.patch"
	...
	"${FILESDIR}/${PN}-83.0.4103.61-create-extra-view-redefinition.patch"
	...
	"${FILESDIR}/${PN}-83.0.4103.61-aarch64-fixes.patch"
	"${FILESDIR}/${PN}-83.0.4103.61-elf-arm.patch"
	"${FILESDIR}/${PN}-83.0.4103.61-make-some-of-blink-custom-iterators-STL-comaptible.patch"
	"${FILESDIR}/${PN}-83.0.4103.61-remove-unsupported-compiler-warnining.patch"
	# Modified musl patch from Alpine Linux
	"${FILESDIR}/${PN}-83.0.4103.61-add-missing-limits-headers.patch"
