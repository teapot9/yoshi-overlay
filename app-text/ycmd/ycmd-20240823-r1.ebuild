...
PYTHON_REQ_USE="xml(+)"
COMMIT_HASH="8b61f198f9c824ce3ef246e5fd542a2304c9275e"
...
# TODO: upstream uses gopls 0.16.1 but not available in ::gentoo
CLANG_VERSION=18
...
RDEPEND="
	...
	java? ( =dev-java/eclipse-jdt-ls-bin-1.36* )
	javascript? ( >=dev-lang/typescript-5.4.5 )
	rust? ( || (
...
src_prepare() {
	...
	ignore_test ycmd/tests/typescript/diagnostics_test.py \
