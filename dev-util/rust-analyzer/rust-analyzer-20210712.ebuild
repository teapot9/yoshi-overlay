...
LICENSE="Apache-2.0 BSD ISC MIT || ( Artistic-2 CC0-1.0 )"
SLOT="0"
KEYWORDS="~amd64"
IUSE="test"
...
DEPEND=""
RDEPEND="|| ( dev-lang/rust[rls,rustfmt] dev-lang/rust-bin[rls,rustfmt] )"
BDEPEND="test? ( ${RDEPEND} )
	>=virtual/rust-1.53.0
"

DOCS=(docs/user docs/dev README.md)
...
src_test() {
	local skip=(
		# ide syntax_highlighting failing tests
		test_extern_crate
		test_flattening
		test_highlight_doc_comment
		test_highlighting
		test_injection
		test_rainbow_highlighting
		test_string_highlighting
		test_unsafe_highlighting
		# rust-analyzer failing tests
	...
	cargo_src_test -- \
		$(for test in "${skip[@]}"; do echo "--skip=${test}"; done)
}
